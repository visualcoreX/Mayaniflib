...
namespace Niflib {
	...
	public:
		...
		/*!
		 * Gets the emissive multiplier of this material (Fallout 3/NV+). Scales the
		 * emissive colour; 1.0 is the neutral default.
		 * \return The current emissive multiplier.
		 */
		NIFLIB_API float GetEmissiveMult() const;

		/*!
		 * Sets the emissive multiplier of this material (Fallout 3/NV+). Scales the
		 * emissive colour; 1.0 is the neutral default.
		 * \param[in] n The new emissive multiplier.
		 */
		NIFLIB_API void SetEmissiveMult(float n);
